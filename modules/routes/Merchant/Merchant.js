...
router.post("/merchant_registration",validateAccess.isValidUser,fileUploadHelper.uploadUserProfileImage.fields([{ name: 'address_proof'},{ name: 'valid_ID'},{name: 'TIN_card'}]), controller.merchantRegistration);
router.post("/merchant_resubmit_images",validateAccess.isValidUser,fileUploadHelper.uploadUserProfileImage.fields([{ name: 'address_proof'},{ name: 'valid_ID'},{name: 'TIN_card'},{ name: 'upgraded_image1'},{ name: 'upgraded_image2'},{name: 'upgraded_image3'},{name: 'upgraded_image4'}]), controller.merchantResubmitImages);
