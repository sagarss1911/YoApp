 ...
 */
 ...
 /**
 * @swagger
 * /api/v1/notification_details/recharge_details/{recharge_id}:
 *   get:
 *     summary: Get All information of Recharge.
 *     tags:
 *      - Notification Details
 *     parameters :
 *     - name: x-auth-api-key
 ...
 *                   example: 400
 */
  let rechargeDetails = (req, res, next) => {
    let userid = req.user ? req.user.userId : null;
    return notificationDetailsManager
        .rechargeDetails(userid, req.params.recharge_id, req)
        .then(data => {
            let result = {
                status: 200,
                data: data
